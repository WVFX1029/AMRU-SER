...
await message.client.sendMessage(message.jid, fs.readFileSync('Kaztroser/wvfx.webp'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        }
